...
export const APIS = [MtcAgentControllerService, MtcCustomerControllerService, MtcGsGeolocationControllerService, MtcNotesControllerService, MtcTransferServiceControllerService];
